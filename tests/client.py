...
for x in range(10,2000):
	MESSAGE = str(x+10.5)+";"+str(x/10.3)+";"+str(x-1/10.2)+";"+str(x-2/10.2)+";"+str(x)+";"+str(x+1)+";"+str(x)+";"+str(x+5.2)+";"+str(x+6.2)+";"+str(x+7.1)+";"+str(x+8.3)+";"+str(x+9.4)+";"+str(x+10.4)+";"+str(x+9.4)+";"+str(x+10.4)+";"+str(x+9.4)+";"+str(x+10.4)+";"+str(x+9.4)
	print MESSAGE

...
%% RAW2MODEL Takes a user input and convert it to a feature vector
%  RAW --> user input from RACE DATA
%raw is[gas; brakes; steering; gear; speed; time; check];
%  CLASS -> class of the user used for classification (name)
...
%% First order derivative of cepstrum
...
%% Second order derivative of cepstrum
...
%% check if any of the parameters is NAN or INF and set to 0
...
%% Assign the class to the vector
if exist('class', 'var')
    parameters(1,size(parameters,2)+1) = class;
end

%parameters = parameters(1,[2 8 9 10 11 14 15 17 27 31 32 39 49 66 86 91 92 101 102 104 106]);
